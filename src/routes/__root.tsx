...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Carbon Flow Exchange enables users to convert verified carbon offset units into FLO ecosystem tokens." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Carbon Flow Exchange enables users to convert verified carbon offset units into FLO ecosystem tokens." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Carbon Flow Exchange enables users to convert verified carbon offset units into FLO ecosystem tokens." },
